defmodule HrSystemWeb.EmployeeLiveTest do
  use HrSystemWeb.ConnCase

  import Phoenix.LiveViewTest
  import HrSystem.HumanResourcesFixtures

  @create_attrs %{department: "some department", employee_id: "some employee_id", first_name: "some first_name", hire_date: "2023-05-03", last_name: "some last_name"}
  @update_attrs %{department: "some updated department", employee_id: "some updated employee_id", first_name: "some updated first_name", hire_date: "2023-05-04", last_name: "some updated last_name"}
