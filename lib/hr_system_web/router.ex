defmodule HrSystemWeb.Router do
  use HrSystemWeb, :router

  pipeline :browser do
    plug :accepts, ["html"]
    plug :fetch_session
    plug :fetch_live_flash
    plug :put_root_layout, {HrSystemWeb.Layouts, :root}
  ...
  if Application.compile_env(:hr_system, :dev_routes) do
    ...
    scope "/dev" do
      ...
      live_dashboard "/dashboard", metrics: HrSystemWeb.Telemetry
