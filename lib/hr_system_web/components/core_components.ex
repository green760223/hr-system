defmodule HrSystemWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(HrSystemWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(HrSystemWeb.Gettext, "errors", msg, opts)
    end
  end
